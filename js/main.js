...
function keymenu(e) {
	e = e || window.event
	if (e.keyCode == '37' && keysLocked == 0) { //Left arrow
		prevPage();
	}
	else if (e.keyCode == '38' && keysLocked == 0) { //Up arrow
		raise();
	}
	else if (e.keyCode == '39' && keysLocked == 0) { //Right arrow
		nextPage();
	}
	else if (e.keyCode == '40' && keysLocked == 0) { //Down arrow
		lower();
	}
	else if (e.keyCode == '83' && keysLocked == 0) { //Search-box focus
	    d.getElementById("searchbox").focus();
	    e.preventDefault();
	}
	else if (e.keyCode >= '48' && e.keyCode <= '57' && keysLocked == 0) { //Number hotkeys for links
